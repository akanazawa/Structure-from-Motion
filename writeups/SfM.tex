...
\begin{figure}[!ht]
  \begin{center}
  \includegraphics[scale=0.5]{hotel.pdf}
...
\begin{figure}[!ht]
  \begin{center}
  \includegraphics[scale=0.5]{hessian.pdf}
...
\begin{figure}[!ht]
  \begin{center}
  \includegraphics[scale=0.5]{keypoints.pdf}
...
\begin{figure}[!ht]
  \begin{center}
  \includegraphics[scale=0.5]{tracked.pdf}
...
\begin{figure}[!ht]
  \begin{center}
  \includegraphics[scale=0.8]{camerapath.pdf}
...
\begin{figure}[!t]
  \begin{center}
  \includegraphics[scale=0.5]{3d1.pdf}
...
\begin{figure}[!t]
  \begin{center}
  \includegraphics[scale=0.5]{3d2.pdf}
  \caption{3D world points before and after removing the affine ambiguity} 
  \label{fig:3D2}
  \end{center}
\end{figure}
\begin{figure}[!t]
  \begin{center}
  \includegraphics[scale=0.5]{3d3.pdf}
  \caption{3D world points before and after removing the affine ambiguity} 
  \label{fig:3D3}
  \end{center}
\end{figure}
