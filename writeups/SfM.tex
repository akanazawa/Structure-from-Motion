...
\textsc{\LARGE CMSC660 Scientific Computing}\\[1.5cm]

\textsc{\Large Final Project}\\[0.5cm]

\HRule \\[0.5cm]

{ \huge \bfseries Affine Structure from Motion}\\[0.4cm]

\HRule \\[1.5cm]

{\large Angjoo Kanazawa}

\vfill

{\large December 19th, 2011}
...
Every step discussed above was implemented in MATLAB (appendix A). As
